...
class AdminController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            $allUserByDateCount = User::select(DB::raw('DATE_FORMAT(`created_at`, "%Y-%m-%d") as created_date'), DB::raw('count(*) as total'))->groupBy(DB::raw('DATE_FORMAT(`created_at`, "%Y-%m-%d")'))->get();
